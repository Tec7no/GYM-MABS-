...
<h2 class="content" style="font-size : 40px;"><span class="span2">Fat&nbsp; </span>burners</h2> 

<div class="mc_amazon_card_box">

    <a href="fat_burners.php" class="mc_amazon_card">                             <!-- clothes tag -->
      <img src="img/fat_burners/f1.jpg" alt="Avatar" style="width:100%">
    ...
    <a href="sports_supp.php" class="mc_amazon_card"> <!-- clothes tag -->
      <img src="img/fat_burners/f2.jpg" alt="Avatar" style="width:100%">
      <div class="mc_amazon_card_container" style="background-color: black;">
    ...
    <a href="fat_burners.php" class="mc_amazon_card">                             <!-- clothes tag -->
      <img src="img/fat_burners/f3.jpg" alt="Avatar" style="width:100%">
      <div class="mc_amazon_card_container" style="background-color: black;">
        <span style="color: #fff;">The hottest fashion show!</span> 
        <p style="color: #fff;">See more</p> 
      </div>
  ...
  <div class="mc_amazon_card_box">  
    <a href="protain_bar.php" class="mc_amazon_card"> 
      <img src="img/fat_burners/f5.jpg" alt="Avatar" style="width:100%">
      <div class="mc_amazon_card_container" style="background-color: black;">
    ...
    <a href="healthy_food.php" class="mc_amazon_card">
        <img src="img/fat_burners/f4.jpg" alt="Avatar" style="width:100%">
        <div class="mc_amazon_card_container" style="background-color: black;">
    ...
    <a href="fat_burners.php" class="mc_amazon_card">  <!-- fat burners tag -->
      <img src="img/fat_burners/f6.jpg" alt="Avatar" style="width:100%">
      <div class="mc_amazon_card_container" style="background-color: black;">
